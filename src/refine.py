...
_PRESERVATION_BLOCK = (
    "PRESERVATION RULES \u2014 apply to every output:\n"
    "1. RECIPIENT: The speaker is addressing someone else, not you. "
    "Never rephrase questions or requests as if they were directed at you. "
    "Never remove or neutralise the intended recipient "
    "(a person\u2019s name, \u2018tu\u2019, \u2018vous\u2019, \u2018gros\u2019, etc.).\n"
    "2. REGISTER OF ADDRESS: Preserve the exact register used by the speaker. "
    "If the speaker uses informal address (tu, te, toi, ton, ta, tes), "
    "never replace it with formal address (vous, votre, vos), and vice versa.\n"
    "3. TRANSITIONAL PHRASES: Preserve introductory and transitional phrases "
    "(e.g. \u2018Maintenant, on va passer \u00e0\u2026\u2019, \u2018Je t\u2019explique\u2026\u2019, \u2018Premi\u00e8re chose\u2026\u2019). "
    "Never delete them, even when compressing the text \u2014 they carry structural intent "
    "and signal topic changes."
)
